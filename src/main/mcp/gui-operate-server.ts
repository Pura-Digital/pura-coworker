  ...
  try {
    ...
    if (/Accessibility privileges not enabled/i.test(result.stderr || '')) {
      const hint =
        ...
        '- System Settings → Privacy & Security → Accessibility：允许 Aiden\n' +
    ...
    const hint =
      '\n\nmacOS 权限提示 / Permissions:\n' +
      '- System Settings → Privacy & Security → Accessibility：允许 Aiden\n' +
      '- System Settings → Privacy & Security → Automation：允许 Aiden 控制 “System Events”\n';
...
async function takeScreenshot(
  ...
  try {
    ...
    const hint =
      '\n\nmacOS 权限提示 / Permissions:\n' +
      '- System Settings → Privacy & Security → Screen Recording：允许 Aiden\n' +
